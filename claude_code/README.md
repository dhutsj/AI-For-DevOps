...
All the Claude's configuration file is sitting in `~/.claude` directory. You can refer to this doc https://code.claude.com/docs/en/claude-directory. [CLAUDE.md](https://github.com/dhutsj/AI-For-DevOps/blob/main/claude_code/CLAUDE.md) loads into every session.
